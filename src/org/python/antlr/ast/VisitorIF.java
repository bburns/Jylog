...
public interface VisitorIF<R> {
    ...
    public R visitSQLQuery(SQLQuery node) throws Exception;
    public R visitSQLInsert(SQLInsert node) throws Exception;
    public R visitProlog(Prolog node) throws Exception; //jylog
    public R visitPrologQuery(PrologQuery node) throws Exception; //jylog
    public R visitSIMQuery(SIMQuery node) throws Exception;
    public R visitSIMInsert(SIMInsert node) throws Exception;
    public R visitSIMClass(SIMClass node) throws Exception;
