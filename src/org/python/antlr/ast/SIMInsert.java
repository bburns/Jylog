...
@ExposedType(name = "_ast.SIMInsert", base = AST.class)
public class SIMInsert extends stmt {
public static final PyType TYPE = PyType.fromClass(SIMInsert.class);
    private expr dest;
    ...
    public SIMInsert(PyType subType) {
        super(subType);
    }
    public SIMInsert() {
        this(TYPE);
    ...
    @ExposedNew
    @ExposedMethod
    public void SIMInsert___init__(PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("SIMInsert", args, keywords, new String[]
    ...
    public static Map<String,SIMInsert>  SIMInserts = new HashMap<String, SIMInsert>();
    public static Integer entnum = new Integer(214);
    
    public SIMInsert(int dummy, Token token, String table, java.util.List<String> attrs, java.util.List<expr> values) {
        super(token);
        SIMInserts.put(this.toString(), this);
        qtbls.add(table);
        qattrs.add(attrs);
        this.values = values;
        if (values == null) {
    ...
    public static void sqlGetInsertProcessor(java.util.List<PyObject> insert, String node_name) {
        SIMInserts.get(node_name).sqlProcessInsert(insert);
        // SIMInserts.remove(node_name);
    }
    ...
    public String toStringTree() {
        StringBuffer sb = new StringBuffer("SIMInsert(");
        sb.append("dest=");
    ...
    public <R> R accept(VisitorIF<R> visitor) throws Exception {
        return visitor.visitSIMInsert(this);
    }
