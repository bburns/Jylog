...
public class PrologQuery extends stmt {
public static final PyType TYPE = PyType.fromClass(PrologQuery.class);
    private expr dest;
    ...
    public PrologQuery(PyType subType) {
        super(subType);
    }
    public PrologQuery() {
        this(TYPE);
    ...
    @ExposedNew
    @ExposedMethod
    public void PrologQuery___init__(PyObject[] args, String[] keywords) {
        ArgParser ap = new ArgParser("PrologQuery", args, keywords, new String[]
    ...
    public static Map<String,PrologQuery>  PrologQueries = new HashMap<String, PrologQuery>();

    public PrologQuery(int dummy, Token token, String predicateName, java.util.List<expr> arguments) {
        super(token);
        PrologQueries.put(this.toString(), this);
        //System.out.printf("PrologQuery(%s, %s)\n", predicateName, arguments);
    ...
    public void prologQueryProcessInsert(java.util.List<PyObject> exprs) {
        ...
        //System.out.printf("prologQueryProcessInsert(%s)\n", exprs);
        ...
        //. re-add this stuff if can figure out how to do use it with prolog
        /*
        // Directory of store
        ...
        for (int i = 0; i < a.size(); i++) {
            ...
            s1.addProperty(p1, exprs.get(i).toString());
        }   
        // Synchronize
        TDB.sync(model);
        // Close
    ...
    public String toStringTree() {
        StringBuffer sb = new StringBuffer("PrologQuery(");
        sb.append("dest=");
    ...
    public <R> R accept(VisitorIF<R> visitor) throws Exception {
        return visitor.visitPrologQuery(this);
    }
